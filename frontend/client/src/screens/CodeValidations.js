...
const CodeValidationsBase = observer((props) => {
  ...
  const genNewCode = async () => {
    try {
      ...
      // need to import analytics?  and make analytics testable in dev by removing conditional in firebase.js and resolve local error caused by removing it
      // log a new Firebase event to count the number of codes generated by organization
      
      // analytics.logEvent('getVerificationCode_w_org_ID', {
